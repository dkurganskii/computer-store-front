...
const Login = ({ history }) => {
    ...
    const loginForm = () => <form onSubmit={handleSubmit}>
        ...
        <br />
        <Button onClick={handleSubmit} type='primary' className='mb-3' block shape='round'
            icon={<MailOutlined />} size='large' disabled={!email || password.length < 6}>Login with Email/Password</Button>
    </form>
